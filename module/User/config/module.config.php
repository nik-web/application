...
return [
    ...
    'service_manager'    => [
        'aliases'   => [
            Repository\UserInterface::class          => Repository\LaminasDbTableGatewayUser::class,
            ...
            Repository\SecuritytokenInterface::class => Repository\LaminasDbTableGatewaySecuritytoken::class,
        ],
        'factories'      => [
            Repository\LaminasDbTableGatewayUser::class          => Repository\Factory\LaminasDbTableGatewayUserFactory::class,
            ...
            Repository\LaminasDbTableGatewaySecuritytoken::class => Repository\Factory\LaminasDbTableGatewaySecuritytokenFactory::class,            
